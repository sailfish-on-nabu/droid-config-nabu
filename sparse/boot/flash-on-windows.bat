...
set unlockwebsite=https://en.miui.com/unlock/index.html
...
@call :fastboot flash vendor_boot_a vendor_boot.img
@call :fastboot flash vendor_boot_b vendor_boot.img
